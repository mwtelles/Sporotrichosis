<div>
    <div>
            ...
            <div class="mt-2">
                    ...
                    <div class="flex-1 flex flex-col md:flex-row">
                        <div class="w-full flex-1 mx-2">
                            <div class="my-2 p-1 bg-white flex border border-gray-200 rounded">
                                <input placeholder="Nome" wire:model="animal.nome"
                                       class="p-1 px-2 appearance-none outline-none w-full text-gray-800 "></div>
                        </div>
                        <div class="w-full flex-1 mx-2">
                            <div class="my-2 p-1 bg-white flex border border-gray-200 rounded">
                                <input wire:model="animal.anos" type="number" placeholder="Anos"
                                       class="p-1 px-2 appearance-none outline-none w-full text-gray-800 "></div>
                        </div>
                        <div class="w-full flex-1 mx-2">
                            <div class="my-2 p-1 bg-white flex border border-gray-200 rounded">
                                <input wire:model="animal.meses" type="number" placeholder="Meses"
                                       class="p-1 px-2 appearance-none outline-none w-full text-gray-800 "></div>
                        </div>
                        <select wire:model="animal.especie" class="mx-2 flex-1 h-10 mt-2 form-select w-full">
                            <option value=""></option>
                            <option value="1">Felino</option>
                            <option value="2">Canino</option>
                        </select>
                        <select wire:model="animal.sexo" class="mx-2 flex-1 h-10 mt-2 form-select w-full">
                            <option value=""></option>
                            <option value="1">Feminino</option>
                            <option value="2">Masculino</option>
                        </select>
                        <select wire:model="animal.is_castrado" class="mx-2 flex-1 h-10 mt-2 form-select w-full">
                            <option value=""></option>
                ...
                <div class="flex flex-col md:flex-row pb-4 mb-4 border-b border-gray-200">
                    ...
                    <div class="flex-1">
                        <select class="mx-2 flex-1 h-10 mt-2 form-select  w-full"
                                wire:model="responsavel_animal.tipo_responsavel">
                        ...
                        @if(isset($responsavel_animal))
                            @if($responsavel_animal->tipo_responsavel == 1 or $responsavel_animal->tipo_responsavel== 2)
                                <div class="flex flex-col md:flex-row">
                                    ...
                                    <div class="w-full flex-1 mx-2">
                                        <div class="my-2 p-1 bg-white flex border border-gray-200 rounded">
                                            <input placeholder="Local Tratamento"
                                                   wire:model="ong_e_protetor.local_tratamento"
                                                   class="p-1 px-2 appearance-none outline-none w-full text-gray-800 ">
                                        </div>
                                    </div>
                                    <div class="w-full flex-1 mx-2">
                                ...
                                <div class="flex flex-col md:flex-row">
                                    <div class="w-full flex-1 mx-2">
                                        <div class="my-2 p-1 bg-white flex border border-gray-200 rounded">
                                            <input placeholder="Municipio" wire:model="ong_e_protetor.municipio"
                                                   class="p-1 px-2 appearance-none outline-none w-full text-gray-800 ">
                                        </div>
                                    </div>
                                    <div class="w-full flex-1 mx-2">
                                        <div class="my-2 p-1 bg-white flex border border-gray-200 rounded">
                                            <input placeholder="Endereço" wire:model="ong_e_protetor.endereco"
                                                   class="p-1 px-2 appearance-none outline-none w-full text-gray-800 ">
                                        </div>
                                    </div>
                                    <div class="w-full flex-1 mx-2">
                                        <div class="my-2 p-1 bg-white flex border border-gray-200 rounded">
                                            <input placeholder="Bairro" wire:model="ong_e_protetor.bairro"
                                                   class="p-1 px-2 appearance-none outline-none w-full text-gray-800 ">
                                        </div>
                                    </div>
                                    <div class="w-full flex-1 mx-2">
                                        <div class="my-2 p-1 bg-white flex border border-gray-200 rounded">
                                            <input placeholder="Referência" wire:model="ong_e_protetor.referencia"
                                                   class="p-1 px-2 appearance-none outline-none w-full text-gray-800 ">
                                        </div>
                                    </div>
                                    <div class="w-full flex-1 mx-2">
                                        <div class="my-2 p-1 bg-white flex border border-gray-200 rounded">
                                            <input placeholder="Telefone" wire:model="ong_e_protetor.telefone"
                                                   class="p-1 px-2 appearance-none outline-none w-full text-gray-800 ">
                                        </div>
                                    </div>
                                </div>
                            ...
                            @if($responsavel_animal->tipo_responsavel == 3 or $responsavel_animal->tipo_responsavel == 4)
                                <div class="flex flex-col md:flex-row">
                                    <div class="w-full flex-1 mx-2">
                                        <div class="my-2 p-1 bg-white flex border border-gray-200 rounded">
                                            <input placeholder="Nome" wire:model="proprietario_e_tutor.nome"
                                                   class="p-1 px-2 appearance-none outline-none w-full text-gray-800 ">
                                        </div>
                                    </div>
                                    <div class="w-full flex-1 mx-2">
                                        <div class="my-2 p-1 bg-white flex border border-gray-200 rounded">
                                            <input placeholder="Endereço" wire:model="proprietario_e_tutor.endereco"
                                                   class="p-1 px-2 appearance-none outline-none w-full text-gray-800 ">
                                        </div>
                                    </div>
                                    <div class="w-full flex-1 mx-2">
                                        <div class="my-2 p-1 bg-white flex border border-gray-200 rounded">
                                            <input placeholder="Bairro" wire:model="proprietario_e_tutor.bairro"
                                                   class="p-1 px-2 appearance-none outline-none w-full text-gray-800 ">
                                        </div>
                                    </div>
                                    <div class="w-full flex-1 mx-2">
                                        <div class="my-2 p-1 bg-white flex border border-gray-200 rounded">
                                            <input placeholder="Referência" wire:model="proprietario_e_tutor.referencia"
                                                   class="p-1 px-2 appearance-none outline-none w-full text-gray-800 ">
                                        </div>
                                    </div>
                                    <div class="w-full flex-1 mx-2">
                                        <div class="my-2 p-1 bg-white flex border border-gray-200 rounded">
                                            <input placeholder="Telefone" wire:model="proprietario_e_tutor.telefone"
                                                   class="p-1 px-2 appearance-none outline-none w-full text-gray-800 ">
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="flex flex-col md:flex-row pb-4 mb-4">
                    ...
                    <div class="flex-1">
                        ...
                        <select wire:model="ocorrencia.is_diagnostico_clinico"
                                class="mx-2 flex-1 h-10 mt-2 form-select  w-full">
                            <option value="">Selecione uma opção</option>
                            <option value="1">Sim</option>
                            <option value="0">Não</option>
                        </select>

                        <label class="mx-2 flex-1 h-10 mt-2 text-sm text-gray-400">Laboratorial</label><span
                            style="font-size: 10px">Segure SHIFT para selecionar vários.</span>
                        <select multiple multiple="multiple" style='overflow:hidden' size='3' wire:model="laboratoriais"
                                class="mx-2 flex-1 mt-2 form-select  w-full">
                        ...
                        <select wire:model="ocorrencia.is_primeira_vez_doenca"
                                class="mx-2 flex-1 h-10 mt-2 form-select  w-full">
                            <option value="">Selecione uma opção</option>
                            <option value="1">Sim</option>
                            <option value="0">Não</option>
                        ...
                        <hr class="mt-2">
                        <div class="flex flex-col md:flex-row">
                            <div class=" flex-initial  w-64 m-3 font-bold h-6 mx-2 mt-3 text-gray-800">Lesões</div>
                            <div class="flex-initial m-3">
                                ...
                                border-teal-600 transition" wire:click="add_lesao()">Adicionar lesão
                                </button>
                            </div>
                        </div>
                        ...
                        @foreach($ocorrencia_lesoes as $key => $lesao)
                            <div class="w-full flex-1 mx-2">
                                ...
                                <div class="flex flex-wrap items-stretch w-full mb-4 relative">
                                    <div class="flex ">
                                        <span
                                            class="flex items-center leading-normal bg-grey-lighter rounded rounded-r-none border border-r-0 border-grey-light px-3 whitespace-no-wrap text-grey-dark text-sm">Local da lesão</span>
                                    </div>
                                    <input wire:model="ocorrencia_lesoes.{{$key}}.local_lesao" type="text"
                                    ...
                                    <div class="flex ml-2 ">
                                        <span
                                            class="flex items-center leading-normal bg-grey-lighter rounded rounded-r-none border border-r-0 border-grey-light px-3 whitespace-no-wrap text-grey-dark text-sm">Número de lesões</span>
                                    </div>
                                    <input wire:model="ocorrencia_lesoes.{{$key}}.numero_lesoes" type="number"
                                           class="flex-shrink flex-grow flex-auto leading-normal w-px flex-1 border h-10 border-grey-light rounded rounded-l-none px-3 relative focus:border-blue focus:shadow">
                                ...
                                text-red-600
                                border duration-200 ease-in-out
                                border-red-600 transition" wire:click="remove_lesao({{$key}})">Remover
                                        </button>
                                    </div>
                                </div>
                            </div>
                        ...
                        <select wire:model="ocorrencia.protocolo_inicial"
                                class="mx-2 flex-1 h-10 mt-2 form-select  w-full">
                            ...
                            <option value="4">Eutanásia</option>
                            <option value="0">Outros</option>
                        </select>

                        @if($ocorrencia->protocolo_inicial == '0')
                            <label class="mx-2 flex-1 h-10 mt-2 text-sm text-gray-400">Informe o protocolo inicial
                                instituido</label>
                            <div class="w-full flex-1 mx-2">
                                <div class="my-2 p-1 bg-white flex border border-gray-200 rounded">
                                    <textarea wire:model="ocorrencia.outros_protocolos" type="number"
                                              class="p-1 px-2 appearance-none outline-none w-full text-gray-800 "></textarea>
                                </div>
                            </div>
                    @endif
        ...
        text-green-700
        border duration-200 ease-in-out
        border-green-600 transition" wire:click="edit()">Salvar
                        </button>
                    </div>
                </div>
                @if(session()->get('message'))
                    <div id="message"
                         class="fixed right-20 bottom-0  bg-green-400 border-t-4 border-green-600 rounded-b text-teal-darkest px-4 py-3 shadow-md my-2"
                         role="alert">
                        <div class="flex">
                            <svg class="h-6 w-6 text-green-400 mr-4" xmlns="http://www.w3.org/2000/svg"
                                 viewBox="0 0 20 20">
                                <path
